...
class Author(Person):
    """
    Class used to represent an Author
    """

    def __init__(self, id_author, name_author, last_name_author):
        Person.__init__(self, id_person= id_author,name= name_author,last_name=last_name_author)


if __name__ == '__main__':

    edwin = Author(id_author=73577376, name_author="Edwin", last_name_author="Puertas")
    edwin.name_Author = "Edwin. A"
    print(edwin)
